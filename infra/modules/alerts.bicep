...
resource functionFailureAlert 'Microsoft.Insights/scheduledQueryRules@2023-03-15-preview' = {
  ...
  location: location
  properties: {
    displayName: 'Oref Alert: Function execution failed'
    description: 'An oref-alert function invocation failed. Check App Insights for details.'
    severity: 1
    enabled: true
...
resource clientExceptionAlert 'Microsoft.Insights/scheduledQueryRules@2023-03-15-preview' = {
  ...
  location: location
  properties: {
    displayName: 'Oref Alert: Client-side exceptions'
